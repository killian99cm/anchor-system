...
- ✅ **买入口径澄清**（用户 8/21 补充）：9/25 实为**卖出 293.77**（非买入）；12/08 转换转入成本基数确认 = **208.87 份 × 净值 1.0986 = 229.46**（差 0.0046 舍入）；三口径分解：明细 7,594.46（纯买 6,950 + 定投 415 + 转换 229.46）、平台 7,644.46 = 明细 + 50、App 7,224.46 = 明细 - 370；**剩余 ~45-50 元来源待查**（C 类无申购费，疑分红再投资/转换费/未导出流水）；对外口径统一用平台 `cumul=-248.04`
