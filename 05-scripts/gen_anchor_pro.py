...
import paths  # C1：本地私有 token 扫描用桌面根（CI 上该目录不存在自动跳过）
...
def json_block(data):
    ...
    public = {
        ...
        "copy": {
            ...
            "history_lead": "脱敏样本：基于示意本金 ¥50,000 的月度盈亏演示，只展示体系记录方法，不代表真实收益。",
            ...
            "hero_kicker": "Investment operating system",
            "hero_typed": "不靠预测，靠纪律",
            "hero_sub": "四层金字塔投资纪律系统",
            "score_animated": True,
        },
        "pyramid": pyramid,
        ...
        "monthly": [
            {"m": "1月", "v": 600, "up": 1}, {"m": "2月", "v": -450, "up": 0},
            {"m": "3月", "v": 800, "up": 1}, {"m": "4月", "v": 350, "up": 1},
            {"m": "5月", "v": -600, "up": 0}, {"m": "6月", "v": 900, "up": 1},
            {"m": "7月", "v": 250, "up": 1}, {"m": "8月", "v": 500, "up": 1},
        ],
        "rules": [
            {"n": "01", "icon": "🛑", "title": "浮亏不加仓", "cost": "避免越跌越买", "desc": "卫星仓没有浮盈时，不把下跌误判为机会。"},
            {"n": "02", "icon": "🔒", "title": "卖出冻结72小时", "cost": "过滤冲动交易", "desc": "卖出后的资金先进入现金层，至少冷却三天。"},
            {"n": "03", "icon": "📉", "title": "-8% 止损（含缓冲）", "cost": "限制单仓风险", "desc": "浮亏 -8% 触发，1 天缓冲 + 次日 14:30 板块确认再执行，避免恐慌割肉。"},
            {"n": "04", "icon": "📊", "title": "组合回撤线", "cost": "系统级防御", "desc": "-5%、-10%、-15% 对应不同减仓动作，基准随资产新高动态上移。"},
            {"n": "05", "icon": "⏱", "title": "时间止损 30 天", "cost": "拒绝无期限死扛", "desc": "卫星持有超 30 天且跑输大盘 ≥5% → 强制卖出。"},
            {"n": "06", "icon": "🌐", "title": "溢价率 ≤3% 建仓", "cost": "避免溢价双杀", "desc": "场内纳指建仓硬门槛，溢价过高不追，等净值回归。"},
        ],
        "forbidden": [
        ...
        "evo": [
            ...
            {"v": "v3.4", "s": 96, "c": "var(--amber)", "d": "噪声审计\n双报告制度"},
            {"v": "v3.5", "s": 96, "c": "var(--cyan)", "d": "实时同步\n自动化升级"},
        ],
    }
