...
# 持仓显示名映射（与页面一致）
NAME_MAP = {
    "示例宽基基金上证红利ETF联接A": "515180 红利ETF",
    "示例黄金基金": "示例黄金基金",
    "示例联接基金恒生港股通创新药ETF联接C": "创新药ETF联接C",
    "示例行业基金半导体芯片ETF联接C": "半导体芯片ETF联接C",
    "示例联接基金证券ETF联接C": "证券ETF联接C",
    "示例指数基金通利混合A": "示例指数基金通利混合A",
    "示例债券基金": "示例债券基金",
    "示例债券基金B": "示例债券基金B",
    "示例指数基金纳斯达克100指数(QDII)C": "示例指数基金纳指100 QDII C",
    "示例宽基基金纳斯达克100ETF联接A": "华泰纳指100 ETF联接A",
    "余额宝": "余额宝",
}
...
def json_block(data):
    ...
    pyramid = [
        ...
        {"l": "core", "icon": "🚀", "name": "核心增长层 · 20%", "assets": "华泰纳指100 A + 示例指数基金纳指100 C + 示例指数基金通利A", "detail": "年化 10-12% · 定投为主 · PE>35才减仓", "rule": "定投为主", "mv": d["core_mv"]},
