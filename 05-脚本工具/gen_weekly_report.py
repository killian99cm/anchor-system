...
def build_report(data, week_days):
    ...
    holding_rows = []
    name_map = {
        "示例债券基金": "鹏华债券C", "示例债券基金B": "中银债券A",
        "示例宽基基金上证红利ETF联接A": "515180红利", "示例黄金基金": "黄金ETF A",
        "示例指数基金纳斯达克100指数(QDII)C": "纳指C", "示例宽基基金纳斯达克100ETF联接A": "纳指A",
        "示例指数基金通利混合A": "示例指数基金通利A", "示例联接基金恒生港股通创新药ETF联接C": "创新药C",
        "示例联接基金证券ETF联接C": "证券ETF C", "示例行业基金半导体芯片ETF联接C": "半导体C",
        "余额宝": "余额宝",
    }
    for h in holdings:
        if h.get('mv',0) <= 0:
...
> **【AI 补充一句话概括本周主线】**：3-5 句展开 —— 反弹/下跌驱动、主力资金动向、量能变化、板块轮动
...
> **组合本周 {week_pnl:+,.0f}（【X%】）** vs 上证 / 科创50。【AI 补充跑赢或跑输原因】
...
def main():
    ...
    print(f"     请让 Claude/AI 补充: 核心叙事、美股、归因、下周计划")
