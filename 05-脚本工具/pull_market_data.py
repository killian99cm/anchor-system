...
FUND_QUERIES = [
    "示例行业基金半导体芯片ETF联接C 008888 最新净值 日涨跌幅",
    "招商TMT50联接A 217019 最新净值 日涨跌幅",
    "国泰黄金ETF联接 最新净值 日涨跌幅",
    "示例债券基金 015257 最新净值 日涨跌幅",
    "示例债券基金B 最新净值",
    "华泰纳指100 示例指数基金纳指100 示例指数基金全球高端制造 最新净值 日涨跌幅",
    "示例研究基金精选C 示例指数基金通利混合A 最新净值 日涨跌幅",
    "创新药ETF 159992 最新净值 涨跌幅",
    "华泰示例小盘基金增强C 示例混合基金 最新净值",
